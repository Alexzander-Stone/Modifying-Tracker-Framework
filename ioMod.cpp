...
// Overloaded writeText, adds gernerality by allowsing user to write text in a
// different color font.
void IoMod::writeText(const std::string& msg, int x, int y, const SDL_Color rgb) const {
  SDL_Surface* surface = 
    TTF_RenderText_Solid(font, msg.c_str(), rgb);
